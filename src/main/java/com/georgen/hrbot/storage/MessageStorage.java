...
import com.georgen.hrbot.model.serializers.LongSetSerializer;
...
import com.georgen.hrbot.tools.datetime.Yesterday;
...
public class MessageStorage {
    ...
    private File messageControlFile;
    ...
    public MessageStorage(@Qualifier("storageDateParser") DateParser dateParser,
                          @Qualifier("messageControlFile") File messageControlFile) {
        this.dateParser = dateParser;
        this.messageControlFile = messageControlFile;
        updateStorage();
    }
    ...
    private Set<String> getInMemoryFileNames() {
        try {
            String managementJson = FileManager.read(messageControlFile);
    ...
    private void saveCurrentFileNames(Set<String> fileNames) {
        try {
            ...
            FileManager.write(messageControlFile, jsonFileNames);
        } catch (Exception e){
            LOGGER.error(e.getMessage(), e);
        }
    }
