...
import com.georgen.hrbot.model.constants.TelegramDefaults;
...
public class TelegramSettings {
    ...
    public String getStickerSetName() {
        if (this.stickerSetName == null) return "";
        return stickerSetName;
    }

    public void setStickerSetName(String stickerSetName) { this.stickerSetName = stickerSetName; }
    ...
    public boolean isEmpty(){
        return this.getChatIDs().isEmpty() || this.getBotToken() == null;
    }
}
